...
import { getProductBySlug, getRelatedProducts } from '@affiliate/api/products'
import { getArticlesByProductId } from '@affiliate/api/articles'
import { buildCanonicalUrl } from '@affiliate/utils/seo'

// SEO Components
import { ProductJsonLd } from '@affiliate/ui/seo/ProductJsonLd'
import { BreadcrumbJsonLd } from '@affiliate/ui/seo/BreadcrumbJsonLd'
...
} from '@affiliate/layouts/product'
...
export async function generateStaticParams() {
  const { getAllSites } = await import('@affiliate/api/sites')
  const { getProducts } = await import('@affiliate/api/products')
