 ...
 *
 * Note: The ImageGallery component must be provided via props or context
...
export default function HeroSection({
  ...
  const ImageGallery = components?.ImageGallery

  // Gallery-only mode - just render the gallery
  if (galleryOnly) {
    if (!ImageGallery) {
      // Fallback: simple image display if no gallery component provided
