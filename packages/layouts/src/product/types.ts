...
import type { SiteWithNiche, ContentSlugType, ProductWithCategories, AffiliateLink, ProductCardData } from '@affiliate/types'
...
/**
 * Props for the StickyBuyBar component.
 */
...
export interface ProductPageContextData {
  ...
  // App-specific components passed via props (optional)
  components?: {
    ImageGallery?: React.ComponentType<ImageGalleryProps>
    StickyBuyBar?: React.ComponentType<StickyBuyBarProps>
  }
}
